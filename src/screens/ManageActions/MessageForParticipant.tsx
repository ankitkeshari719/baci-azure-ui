...
import { OutlinedInput, Box, styled } from '@mui/material';
...
const MessageForParticipant = ({
  ...
  return (
    <Box
      sx={{
        height: userType == 2 && expandMessageForParticipant ? '166px' : '48px',
        width: '100%',
        display: 'flex',
        position: 'relative',
        // marginLeft: '12px',
            ...
            <Box component="span">
              <Box component="span" fontSize="12px" marginRight="12px">
                ...
                {actionsData.messageForParicipants != ''
                  ? actionsData.messageForParicipants == messageForParticipant
                    ? 'Message Posted'
        ...
        {userType == 2 && expandMessageForParticipant && (
          <Box display="flex" flexDirection="column" width="100%" height="100%">
            <TextFieldNoBorderWrapper
              ...
              onChange={e => setMessageForParticipant(e.currentTarget.value)}
            ...
            >
              ...
              <ButtonWithIconWithNoBorder
                ...
                error={true}
                onClick={res => {
                  setExpandMessageForParticipant(!expandMessageForParticipant);
                }}
              />
            </Box>
          </Box>
