  ...
  return (
    <>
      ...
      >
        ...
        {/************************************* Print Box *******************************/}
        <Box id="print_box" display="none">
          {/* Top Data */}
          <Box id="top_data_print">
            <Box
              sx={{
          ...
          {/* -------------------- ---Page Header ----------------------------- */}
          <Grid id="page_header_1" item xs={12}>
            <Box
              sx={{
                display: 'flex',
                alignItems: 'center',
          ...
          {/* -------------------- ---Page Header ----------------------------- */}
          <Grid id="page_header_2" item xs={12} style={{ marginTop: '108px' }}>
            <Box
              sx={{
                display: 'flex',
                alignItems: 'center',
          ...
          {/* -------------------- ---Page Header ----------------------------- */}
          <Grid id="page_header_1" item xs={12} style={{ marginTop: '108px' }}>
            <Box
              sx={{
                display: 'flex',
                alignItems: 'center',
