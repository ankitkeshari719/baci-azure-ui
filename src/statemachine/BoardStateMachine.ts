import {
  ...
  export enum BoardActionType {
    ...
    END_RETRO = 'endRetro',
    SHOW_DISABLED_BOARD = 'showDisabledBoard',
    DELETE_ALL_CARDS = 'deleteAllCards',
  }
  ...
  export const validateAction = (
    ...
    const needsToShowFlag = (flag: boolean) => {
      return (state.needsToShow = flag);
    };
    ...
    switch (actionName) {
      ...
      case BoardActionType.SHOW_DISABLED_BOARD:
        return needsToShowFlag(parameters.flag);
      default:
        return false;
    }
  };
  ...
  export const processAction = (
    ...
    switch (actionName) {
      ...
      case BoardActionType.END_RETRO:
        ...
        break;
      case BoardActionType.SHOW_DISABLED_BOARD:
        needsToShowFlag(parameters.flag);
        break;
